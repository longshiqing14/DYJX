...
var xtt = (function(document, undefined) {
	...
	$.getClientId = function() {
		...
		if(importedClass) {
			...
			$.enterpriseId = importedClass.getEnterpriseId();
		} else {
...
(function($) {
	...
	var remoteServer = 'http://www.xtt168.com:8090/remote/EA';
	var updateUrl = 'http://www.xtt168.com:8090/update/EA/update.json';
