    ...
    switch (_libraryType) {
        case SLT_Native:
        {
            ...
            if (!_scanObj )
            {
                ...
                self.scanObj = [[LBXScanNative alloc]initWithPreView:videoView ObjectType:@[strCode,AVMetadataObjectTypeEAN13Code] cropRect:cropRect success:^(NSArray<LBXScanResult *> *array) {
