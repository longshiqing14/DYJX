...
{
    if (_numLabels == nil) {
        _numLabels = [NSMutableArray array];
    }
    return _numLabels;
}
...
//        UILabel * redNumLB = [[UILabel alloc]init];
//        redNumLB.textColor = XYWhiteColor;
//        redNumLB.textAlignment = NSTextAlignmentCenter;
//        redNumLB.font = XYFont_10;
//        [redNumLB.layer setMasksToBounds:YES];
//        [redNumLB.layer setCornerRadius:15/2];
//        redNumLB.frame = CGRectMake(labelX + labelW , (_titleHeight-15)/2, 15, 15);//(_titleHeight-5)/2
//        
//        NSString * redNumStr = [XYOrderCommon numOrderRedMarkViewController:vc];
//        redNumLB.text = redNumStr;
//        
//        if ([redNumStr integerValue] != 0) {
//            redNumLB.backgroundColor = [UIColor redColor];
//        }else{
//            redNumLB.backgroundColor = XYWhiteColor;
//        }
//        
//        // 保存到数组
//        [self.numLabels addObject:redNumLB];
//        
//        [_titleScrollView addSubview:redNumLB];
...
- (void)refreshDisplay
{
    ...
    [self.numLabels makeObjectsPerformSelector:@selector(removeFromSuperview)];
    [self.numLabels removeAllObjects];
