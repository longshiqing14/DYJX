//
//  XYEWalletBalanceRecordTVCell.m
//  user
//
...
@implementation XYEWalletBalanceRecordTVCell

//static CGFloat const imageViewHeight = 15;
...
- (UILabel*)timeLB
{
    if (_timeLB == nil) {
        ...
        _timeLB.textColor = XYBlackColor;
...
+ (instancetype)cellWithTableView:(UITableView *)tableView {
    ...
    XYEWalletBalanceRecordTVCell *cell = [tableView dequeueReusableCellWithIdentifier:ID];
    if (!cell) {
        cell = [[XYEWalletBalanceRecordTVCell alloc] initWithStyle:UITableViewCellStyleValue1 reuseIdentifier:ID];
