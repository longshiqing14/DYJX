//
//  UIAlertController+XYAlertController.m
//  user
//
...
@implementation UIAlertController (XYAlertController)
...
+(instancetype)alertWithTitle:(NSString *)title text:(NSString *)text buttonTitles:(NSArray<NSString *> *)buttonTitles destructiveButtonIndex:(NSUInteger)destructiveButtonIndex handleBlock:(void (^)(NSUInteger))handleBlock
{
                  ...
                  handleBlock:(void (^)(NSUInteger, NSString *))handleBlock
{
    ...
    __weak typeof(alert) weakAlert = alert;
    [alert addTextFieldWithConfigurationHandler:textFieldConfigurationBlock];
    alert.textFields.firstObject.placeholder = textFieldPlaceHolder;
    NSArray<NSString *> *buttonTitles = @[leftButtonTitle ? : @"",rightButtonTitle ? : @""];
    UIAlertAction *buttonAction = nil;
    NSUInteger index = 0;
    for (NSString *buttonTitle in buttonTitles) {
