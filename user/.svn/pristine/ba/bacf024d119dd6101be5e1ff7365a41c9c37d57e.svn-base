...
@interface JXPointsRecordVCSiftHeaderView : UIView
/** 标题名 */
...
@implementation JXPointsRecordVCSiftHeaderView
...
@interface JXPointsRecordVCSiftVC ()<UITableViewDelegate,UITableViewDataSource,XYDatePickerViewDelegate>
...
@implementation JXPointsRecordVCSiftVC
...
{
    JXPointsRecordVCSiftHeaderView *headV = [[JXPointsRecordVCSiftHeaderView alloc] initWithFrame:CGRectMake(0, 0, self.tableWidth, 36)];
