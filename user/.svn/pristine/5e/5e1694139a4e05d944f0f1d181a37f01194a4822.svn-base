...
#import "XYEWalletBalanceRecordVC.h"

#import "XYEWalletBalanceRecordTVCell.h"
...
#import "XYEWalletBalanceRecordSiftVC.h"//筛选
@interface XYEWalletBalanceRecordVC () <UITableViewDelegate,UITableViewDataSource,XYEWalletBalanceRecordSiftVCDelegate>
...
@property(strong,nonatomic) XYEWalletBalanceRecordSiftVC *recordSiftVC ;
...
@implementation XYEWalletBalanceRecordVC

- (void)viewDidLoad {
    [super viewDidLoad];

    self.navigationItem.title = @"余额变动记录";
...
-(XYEWalletBalanceRecordSiftVC *)recordSiftVC
{
    if (!_recordSiftVC) {
        _recordSiftVC = [[XYEWalletBalanceRecordSiftVC alloc] init];
...
{
    XYEWalletBalanceRecordTVCell * cell = [XYEWalletBalanceRecordTVCell cellWithTableView:tableView];
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    XYEWalletBalanceRecordDetailVC * detailVC = [[XYEWalletBalanceRecordDetailVC alloc]init];
