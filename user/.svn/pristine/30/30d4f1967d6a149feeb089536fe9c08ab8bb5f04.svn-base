//
//  JXPiontsRecordListVC.m
//  user
//
//  Created by 岩  熊 on 2018/1/11.
...
@interface JXPiontsRecordListVC ()<UITableViewDelegate,UITableViewDataSource>
...
@implementation JXPiontsRecordListVC
