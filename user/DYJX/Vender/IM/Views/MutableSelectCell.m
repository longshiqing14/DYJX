...
@implementation MutableSelectCell
...
-(void)setIsMutble:(BOOL)isMutble {
    self.selectButton.hidden = !isMutble;
    if (isMutble) {
        self.selectButton.frame = CGRectMake(kScreenWidth - 30, 20, 20, 20);
        self.timeLabel.frame = CGRectMake(kScreenWidth - 190, 10.5, 150, 14);
        self.dotLabel.frame = CGRectMake(kScreenWidth - 50, 34, 16, 16);
    }
    else {
        self.selectButton.frame = CGRectMake(kScreenWidth, 20, 20, 20);
        self.timeLabel.frame = CGRectMake(kScreenWidth - 160, 10.5, 150, 14);
        self.dotLabel.frame = CGRectMake(kScreenWidth - 26, 34, 16, 16);
    }
}
...
-(UIImageView *)selectButton {
    if (!_selectButton) {
        _selectButton = [[UIImageView alloc] init];
        _selectButton.image = [UIImage imageNamed:@"dyjx_contract_button_normal"];
    }
...
-(UILabel *)timeLabel {
    if (!_timeLabel) {
        ...
        _timeLabel.frame = CGRectMake(kScreenWidth - 110, 10.5, 100, 14);
    }
    return _timeLabel;
}
-(UILabel *)dotLabel {
    if (!_dotLabel) {
        _dotLabel = [[UILabel alloc] initWithFrame:CGRectMake(kScreenWidth - 26, 34, 16, 16)];
