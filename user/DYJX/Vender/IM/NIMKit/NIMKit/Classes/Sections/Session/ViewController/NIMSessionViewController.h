...
@interface NIMSessionViewController : UIViewController<NIMSessionInteractorDelegate,NIMInputActionDelegate,NIMMessageCellDelegate,IMChatDelegate,NIMConversationManagerDelegate>
 ...
 */
@property (nonatomic, strong, readonly)     RCIMMessage *messageForMenu;
