//
//  DYJXGetBackPwdAuthorizationCodeViewModel.m
//  user
//
...
@implementation DYJXGetBackPwdAuthorizationCodeViewModel
...
- (void)getBackPwdAuthorizationCodeWithPhoneNumber:(NSString*)phoneNumber Success:(void(^)(NSString *randCode))success failed:(void(^)(NSString *errorMsg))fail{
    ...
    [XYNetWorking XYPOST:kDYJXAPI_user_GetBackPwdAuthorizationCode params:self.requestDic success:^(NSURLSessionDataTask *task, id responseObject) {
...
- (void)resetPwdWithPhoneNumber:(NSString*)phoneNumber AuthorizationCode:(NSString*)code ranCode:(NSString*)ranCode password:(NSString*)password  Success:(void(^)())success failed:(void(^)(NSString *errorMsg))fail{
    ...
    [self.requestDic setObject:[password md5String] forKey:@"NewPassord"];
    ...
    [XYNetWorking XYPOST:kDYJXAPI_user_GetBackPwd params:self.requestDic success:^(NSURLSessionDataTask *task, id responseObject) {
