...
-(UIButton *)releaseButton {
    if (!_releaseButton) {
        ...
        _releaseButton.layer.cornerRadius = 2.0;
        _releaseButton.layer.borderColor = [UIColor colorWithHexString:@"#F2A73B"].CGColor;
        _releaseButton.layer.borderWidth = 1.0;
        [_releaseButton setTitleColor:[UIColor colorWithHexString:@"#F2A73B"] forState:UIControlStateNormal];
        _releaseButton.titleLabel.font = [UIFont systemFontOfSize:13];
        [_releaseButton setTitle:@"解绑" forState:UIControlStateNormal];
    }
